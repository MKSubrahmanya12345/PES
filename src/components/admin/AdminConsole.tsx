...
type ViewId = 'overview' | 'graph' | 'doubts' | 'stakes' | 'cad-helper' | 'catalog' | 'repositories' | 'activity';
...
const navGroups: { label: string; items: { id: ViewId; label: string; icon: string; count?: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'catalog', label: 'Component catalog', icon: 'grid' },
...
export function AdminConsole() {
  ...
  useEffect(() => {
    ...
    if (view && ['overview', 'graph', 'doubts', 'stakes', 'cad-helper', 'catalog', 'repositories', 'activity'].includes(view)) setActiveView(view);
